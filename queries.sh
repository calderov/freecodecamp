...
echo "$($PSQL "SELECT DISTINCT(name) FROM games FULL JOIN teams ON team_id = winner_id OR team_id = opponent_id WHERE round = 'Eighth-Final' AND year = 2014 ORDER BY name")"
